...
@section('content')
    <h3 class="my-4 text-[1.75rem] font-medium leading-[1.2]"> ESTATUS </h3>
    ...
    <div class="bg-gray-100 p-4 rounded shadow-md">
        ...
        <div class="mb-4 flex items-center justify-between">
            ...
            <a class="h-8 w-8 my-3 btn btn-success flex items-center justify-center" href="{{ route('estatuses.create') }}">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center w-36 align-middle justify-center">
                            <a class="mt-4 btn btn-primary" href="{{ route('estatuses.edit', $e->id) }}"> <i class="fa-solid fa-pencil"></i> </a>
                            <a class="mt-4 btn btn-secundary" href="{{ route('estatuses.show', $e->id) }}"> <i class="fa-solid fa-eye"></i> </a>

                            <form class="btn-form" action="{{  route("estatuses.destroy", $e->id)}}" method="POST">
                                @method("DELETE")
                                @csrf
