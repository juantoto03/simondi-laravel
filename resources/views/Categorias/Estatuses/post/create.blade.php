...
@section('content')
    ...
    <h1 class="ml-0 m-8 text-left"> Insertar Estatus </h1>
    ...
    <div class='div-aling-end'>
        <button id="open-modal" class="btn btn-upload">
            <i class="m-2 fas fa-file-arrow-up"></i>
        </button>
    </div>
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4 ">
                    ...
                    <div class="border-t border-gray-300 my-4"></div>
                        <!-- Contenido del modal -->
                    <div class="mt-2">
                        <form method="POST" action="{{ route('estatuses-importar-csv') }}" enctype="multipart/form-data">
                            @csrf
