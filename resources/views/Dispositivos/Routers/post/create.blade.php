...
@section('content')
    ...
    <h1 class="ml-0 mt-8 text-left"> Crear router </h1>

        @include('Dispositivos.Routers.Fragment._errors-from')
                ...
                <div data-te-modal-dialog-ref
                    ...
                    <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                        <div class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                            {{--  Modal title  --}}
                            <h5 class="text-xl font-medium leading-normal text-neutral-800 dark:text-neutral-200" id="exampleModalCenterTitle"> Importar Routers </h5>
                        ...
                        {{--  Modal body  --}}
                        <div class="mt-2">
                            <form method="POST" action="{{ route('routers-importar-csv') }}" enctype="multipart/form-data">
        ...
        <form clas action="{{ route('routers.store')}}" method="POST">
            
            @include('Dispositivos.Routers.post._form')
