...
@section('content')
    <h3 class="my-4 text-[1.75rem] font-medium leading-[1.2]"> ROUTERS </h3>
    ...
    <div class="bg-gray-100 p-4 rounded shadow-md">
        <div class="mb-4 flex items-center justify-between">
            ...
            <a class="h-8 w-8 my-3 btn btn-success flex items-center justify-center" href="{{ route('routers.create') }}">
            ...
            <table class="table mb-3">
                ...
                <tbody class="border border-slate-300">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $r->estatuses->est_nombre }}
                        </td>
                        <td>
                            {{ $r->modelos->mod_nombre}}
                        </td>
                        ...
                        <td class="text-center w-36 align-middle justify-center">
                            <a class="mt-4 btn btn-primary" href="{{ route('routers.edit', $r->id) }}"><i class="fa-solid fa-pencil"> <i class="fa-solid fa-pencil"> </a>
                            <a class="mt-4 btn btn-secundary" href="{{ route('routers.show', $r->id) }}"><i class="fa-solid fa-eye"> <i class="fa-solid fa-eye"> </a>
                            
                            <form class="btn-form" action="{{  route('routers.destroy', $r->id)}}" method="post">
                                @method("DELETE")
                                @csrf
                                <button class="mt-4 btn btn-danger"  type="submit"><i class="fa-solid fa-trash"> <i class="fa-solid fa-trash"> </button>
                            </form>
