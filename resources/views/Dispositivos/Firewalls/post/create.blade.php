...
@section('content')
    ...
    <h1 class="ml-0 my-8 text-left">Crear Firewall</h1>
                ...
                <div data-te-modal-dialog-ref
                    ...
                    <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                        <div class="flex flex-shrink-0 items-center justify-between rounded-t-md border-b-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                            {{--  Modal title  --}}
                            <h5 class="text-xl font-medium leading-normal text-neutral-800 dark:text-neutral-200" id="exampleModalCenterTitle"> Importar Firewalls </h5>
                        ...
                        {{--  Modal body  --}}
                        <div class="mt-2">
                            <form method="POST" action="{{ route('firewalls-importar-csv') }}" enctype="multipart/form-data">
        ...
        <form clas action="{{ route('firewalls.store')}}" method="POST">
