...
class PutRequest extends FormRequest
{
    ...
    {
        return [
            'rou_nombre' => 'required|min:1|unique:routers,rou_nombre,' . $this->route('router')->id,
            'rou_serial' => 'required|min:1|unique:routers,rou_serial,' . $this->route('router')->id,
            'rou_memoria' => 'required|min:1',
            'rou_cpu' => 'required|min:1',
            'rou_puertos' => 'required|min:1',
            'rou_macadd' => 'required|min:1',
            'rou_ip' => 'required|min:1|unique:Routers,rou_ip,' . $this->route('roue')->id,
