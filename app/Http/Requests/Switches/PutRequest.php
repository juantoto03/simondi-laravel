...
class PutRequest extends FormRequest
{
    ...
    {
        return [
            'swi_nombre' => 'required|min:1|unique:switches,swi_nombre,' . $this->route('switch')->id,
            'swi_serial' => 'required|min:1|unique:switches,swi_serial,' . $this->route('switch')->id,
            'swi_memoria' => 'required|min:1',
            'swi_cpu' => 'required|min:1',
            'swi_puertos' => 'required|min:1',
            'swi_macadd' => 'required|min:1',
            'swi_ip' => 'required|min:1|unique:switches,swi_ip,' . $this->route('switch')->id,
