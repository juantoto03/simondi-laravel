...
namespace App\Http\Controllers\Dashboard\Modelos;
...
class ModelosController extends Controller
{
    ...
    {
        $modelo = Modelos::paginate(20);

        return view('Dashboard.Modelos.post.index', compact('modelo'));
    }
    ...
    public function create()
    {
        ...
        return view('Dashboard.Modelos.post.create',compact('modelo','tipos','marcas'));
    }
    ...
    {
        return view('Dashboard.Modelos.post.show', compact('modelo'));
    }
    ...
    public function edit(Modelos $modelo)
    {
        ...
        return view('Dashboard.Modelos.post.edit', compact('modelo','tipos','marcas'));
    }
