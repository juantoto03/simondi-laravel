...
namespace App\Http\Controllers\Categorias\Estatuses;
...
class EstatusesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Categorias.Estatuses.post.index', compact('estatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('Categorias.Estatuses.post.create',compact('estatus'));
    }
    ...
    {
        return view('Categorias.Estatuses.post.show', compact('estatus'));
    }
    ...
    {
        return view('Categorias.Estatuses.post.edit',compact('estatus'));
    }
